...
bot.on("message", async (msg) => {
 ...
 A) Their B) There C) They’re D) There’s).`);
      ...
      bot.sendPhoto(chatId, "./image.png", { caption: "📌 *Misol:* Oq fonda aniq ko‘rinadigan, test savollari va variantlari tushirilgan rasm.(Huddi shu korinishda bo'lishi shart:)" });
      ...
      bot.sendMessage(chatId, "O‘zingiz qiziqqan savolni yozing, men javob beraman.");
